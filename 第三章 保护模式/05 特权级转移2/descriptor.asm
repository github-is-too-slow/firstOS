...
LABEL_CALL_GATE_TEST:
    Gate        SelectorCodeDest, 0,     0,  DA_386CGate + DA_DPL3 ;存在的特权级为0的调用门
...
LABEL_DESC_TSS:
    Descriptor  0,              TSSLen - 1,           DA_386TSS               ;存在的任务状态段
...
;==============start of section .tss========================
[section .tss]
align 32
[bits 32]
LABEL_TSS:
    dd 0     ;上一次任务链接back
    dd TopOfStack       ;DPL0级堆栈esp0
    dd SelectorStack    ;DPL0级堆栈ss0
    dd 0    ;1级堆栈
    dd 0
    dd 0    ;2级堆栈
    dd 0
