...
/*进程栈总大小*/
#define STACK_SIZE_TOTAL (STACK_SIZE_TESTA + STACK_SIZE_TESTB + STACK_SIZE_TESTC + STACK_SIZE_TASK_TTY + STACK_SIZE_TASK_SYS + STACK_SIZE_TASK_HD + STACK_SIZE_TASK_FS)
