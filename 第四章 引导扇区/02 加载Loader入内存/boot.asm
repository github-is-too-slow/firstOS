...
SectorNoOfRootDir  equ 19   ;根目录占用的起始扇区号
DeltaSectorNo equ 17    ;根据FAT表项值(簇号)X计算对应的扇区号：X + RootDirSectors + SectorNoOfRootDir(19) - 2
MessageLength equ 9     ;显示字符串的固定长度
SectorNoOfFAT1 equ 1      ;FAT1表的第一扇区号 = BPB_RsvdSecCnt
;===================================================================================
